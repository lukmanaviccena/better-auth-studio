...
<div class="container mx-auto p-8">
  <h1 class="text-4xl font-bold mb-6">Better Auth Studio - SvelteKit Example</h1>

  <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg mb-6">
    <h2 class="text-2xl font-semibold mb-4">Welcome</h2>
    <p class="text-gray-700 dark:text-gray-300 mb-4">
      This is a SvelteKit example project using Better Auth with Drizzle ORM and PostgreSQL.
    </p>
    <div class="space-y-2">
